...
namespace DSPAlgorithms.Algorithms
{
    public class MultiplySignalByConstant : Algorithm
    {
        ...
        public override void Run()
        {
            ...
            {
                float multiplicationResult = InputSignal.Samples[i] * InputConstant;
                resultSamples.Add(multiplicationResult);
            }
            OutputMultipliedSignal = new Signal(resultSamples, false);
        }
    }
}